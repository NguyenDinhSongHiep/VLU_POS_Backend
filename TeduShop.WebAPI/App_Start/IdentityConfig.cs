...
namespace TeduShop.Web.App_Start
{
    ...
    {
        public ApplicationUserStore(HeadDbContext context)
            : base(context)
        {
        }
    }
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<HeadDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<HeadDbContext>()));
