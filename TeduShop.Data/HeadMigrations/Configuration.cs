namespace TeduShop.Data.HeadMigrations
{
    using Common;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TeduShop.Data.HeadDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            MigrationsDirectory = @"HeadMigrations";
        }

        protected override void Seed(TeduShop.Data.HeadDbContext context)
        {
        ...
        private void CreateFunction(HeadDbContext context)
        {
        ...
        private void CreateConfigTitle(HeadDbContext context)
        {
        ...
        private void CreateUser(HeadDbContext context)
        {
            var manager = new UserManager<AppUser>(new UserStore<AppUser>(new HeadDbContext()));
            if (manager.Users.Count() == 0)
            {
                var roleManager = new RoleManager<AppRole>(new RoleStore<AppRole>(new HeadDbContext()));
        ...
        private void CreateProductCategorySample(TeduShop.Data.HeadDbContext context)
        {
        ...
        private void CreateFooter(HeadDbContext context)
        {
        ...
        private void CreateSlide(HeadDbContext context)
        {
        ...
        private void CreatePage(HeadDbContext context)
        {
        ...
        private void CreateContactDetail(HeadDbContext context)
        {
